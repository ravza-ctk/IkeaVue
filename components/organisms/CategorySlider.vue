<template>
  ...
  >
    <BaseText variant="section-title" tag="h2" class="slider-title">Düzenle, paylaş, kutla</BaseText>
...
.slider-title {
  ...
  color: #111;
  margin-bottom: 20px;
  padding: 0 20px; /* Restore padding for title */
}
...
.slider-track {
  ...
  padding: 0 20px 20px 20px; /* Add padding to track instead */
...
.nav-btn {
  ...
  width: 44px;
  height: 44px;
  background-color: #111; /* Ensure dark background for circle */
  color: white;
  border: none;
  border-radius: 50%;
  font-size: 24px;
  /* line-height removed, relying on flex */
  cursor: pointer;
  z-index: 10;
  display: flex;
  justify-content: center;
  align-items: center;
  padding: 0; /* Remove padding hack */
